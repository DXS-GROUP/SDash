...
def get_uptime():
    ...
    if platform.system() == "Linux":
        ...
        return run_command("net stats workstation | findstr /C:'Statistics since'")  # Windows uptime command
...
def model_info():
    ...
    if platform.system() == "Linux":
        ...
        return run_command("system_profiler SPHardwareDataType | awk '/Model Name:/ {print $3, $4}'")
